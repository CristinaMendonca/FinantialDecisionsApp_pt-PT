  ...
  dashboardBody(
                          ...
                          column(7,
                            ...
                            HTML("<p>Considere as seguintes sugestões:</p>
                                 <ul>
                                  ...
                                  <li>Procure guias ou listas de compras de imóveis (<a href=\"https://www.cgd.pt/Site/Saldo-Positivo/guias-e-infografias/Documents/infografia-comprar-casa-o-que-precisa-de-saber.pdf\">ver exemplo</a>);</li>
        ...
        tabItem("disp", 
                tabsetPanel(id="tabAH",
                            ...
                            tabPanel(value="prat12", title="Pratique",
                                     box(width=6,
                                         HTML("Agora que já sabe mais sobre o modo como escolher adequadamente um crédito habitação, analise a tabela abaixo e ordene os vários bancos apresentados começando pelo banco que oferece melhores condições até ao que oferece piores condições:<br><br>
                                                  <table class=\"bord\" style=\"width:100%;\">
                                                          <tr class=\"bord\">
                                                            <th class=\"bord\"></th>
                                                            <th class=\"bord\">Banco 1</th>
    ...
    tabItem("sobre",
            box(width=12,
                ...
                br(),
                HTML('<p>Esta aplicação foi desenvolvida por Mário Boto Ferreira, Joana Reis e Cristina Mendonça do grupo de investigação Cognição em Contexto (CO2) do
                  <a href="https://www.psicologia.ulisboa.pt/cicpsi/">Centro de Investigação em Ciência Psicológica</a> (CICPSI), da Faculdade de Psicologia da Universidade de Lisboa,
                     tendo sido financiada pela Fundação para a Ciência e Tecnologia através do projeto PTDC/MHC-PAP/1556/2014.</p>'),
                HTML("<p style=\"text-align:center;\">Esta aplicação encontra-se disponível no <a href=\"https://github.com/CristinaMendonca/FinantialDecisionsApp_pt-PT\">GitHub</a>, siga o link para deixar comentários, ver o código da aplicação ou fazer download dela!</p>"),
                br(),
                fluidRow(
                  column(6, HTML('<img src="fp.png" width="90%">')),
                  column(6, HTML('<img src="fct.png" width="100%">'))
