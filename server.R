...
server = function(input, output, session) {
  ...
  output$checkPracticeAH <- renderUI({
      if (paste(ahP2Select(), collapse=" ") == "") {HTML("Por favor, responda à pergunta ordenado todos os cinco bancos e carregando de novo no botão \"Confirmar\".")}
  ...
  output$feedbackine2 <- renderUI({
      ...
      else if (inP2Radio1() != inP2Radio2() | inP2Radio1() != inP2Radio3()) {
